<template>
    <div id="app">
        ...
        <ion-card button="true" class="card" @click="irA('Diptongo1')"><h2>¡Escoge!</h2></ion-card>
        <ion-card button="true" class="card" @click="irA('Diptongo2')"><h2>¡Selecciona!</h2></ion-card>
    </div>
</template>
