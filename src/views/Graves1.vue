...
<script>
    ...
    export default {
        ...
        mounted() {
            firebase.firestore().collection("PreguntasGraves").doc(this.number.toString(10)).get().then(doc => {
                this.p = doc.data().p;
            ...
            gano: function () {
                ...
                firebase.firestore().collection("PreguntasGraves").doc(this.number.toString(10)).get().then(doc => {
                    if (typeof (doc.data()) !== "undefined") {
                        ...
                        this.number=1;
                        firebase.firestore().collection("PreguntasGraves").doc("1").get().then(doc => {
                            this.p = doc.data().p;
                            this.op1 = doc.data().r1;
                            this.op2 = doc.data().r2;
                            this.op3 = doc.data().r3;
