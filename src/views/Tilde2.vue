...
<script>
    ...
    export default {
        ...
        mounted() {
            firebase.firestore().collection("Uso de las tildes 2").doc(this.number.toString(10)).get().then(doc => {
                this.p = doc.data().P;
            ...
            gano: function () {
                ...
                firebase.firestore().collection("Uso de las tildes 2").doc(this.number.toString(10)).get().then(doc => {
                    if (typeof (doc.data()) !== "undefined") {
                        ...
                        firebase.firestore().collection("Uso de las tildes 2").doc("1").get().then(doc => {
                            this.p = doc.data().P;
                            this.op1 = doc.data().R1;
                            this.op2 = doc.data().R2;
                            this.op3 = doc.data().R3;
